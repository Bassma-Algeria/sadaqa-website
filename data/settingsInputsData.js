...
export const getEditPersonalInformationInputData = (
  errors,
  choosenWilayaId
) => [
  {
...
export const getEditCredentialsInputData = (
  ...
  },
  {
    ...
    type: "password",
    errorMessage: errors,
    iconUrl: isSeeOldPasswordIcon ? seePasswordIcon.src : hidePasswordIcon.src,
  ...
  },
  {
    ...
    type: "password",
    errorMessage: errors,
    iconUrl: isSeeNewPasswordIcon ? seePasswordIcon.src : hidePasswordIcon.src,
    changeSeePasswordIconState: {
  ...
  },
  {
    ...
    type: "password",
    errorMessage: errors,
    iconUrl: isSeeConfirmNewPasswordIcon
      ? seePasswordIcon.src
