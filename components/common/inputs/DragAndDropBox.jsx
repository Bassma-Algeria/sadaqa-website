...
const StyledDragAndDropContainer = styled.div`
  ...
  p.errorMessage {
    ...
    color: #c40707;
    display: ${(props) =>
      props.errorMessage || !props.isDroppedFileIsImage ? "block" : "none"};
  }
...
const DragAndDropBox = ({
  ...
  const handleImageClick = (e) => {
    ...
    e.target.style.transform = !isImageOpened
      ? "translate(-50%, -50%)"
      : "none";
  ...
  const handleRemoveIconClick = (e) => {
    const imagesUploaded = Array.from(
      document.querySelectorAll(".imagesUploaded #uploadedImage")
    );
