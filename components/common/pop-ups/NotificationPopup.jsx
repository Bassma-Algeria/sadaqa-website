...
const NotificationPopup = () => {
  ...
  return (
    <div
      ...
      onClick={() =>
        dispatch(makeNotificationRead(newNotification.notification_id))
      }
...
const messageText = (messageContent) => {
  return `" ${
    messageContent.length > 35 ? messageContent.slice(0, 35) : messageContent
  } "`;
};
