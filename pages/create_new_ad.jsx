        ...
        >
          ...
          <form onSubmit={handleSubmit} className={styles.container}>
            ...
            <p className={styles.note}>
              Note*: Only associations can publish a call for help or family in
              need. <br /> <Link href="/term_of_use">See why.</Link>
            </p>

            <Inputs
              inputValues={newAdInputValues}
              setInputValues={setNewAdInputValues}
            />
